...
import { SUB_ACTION } from '../../../common/genai/constants';
import { BEDROCK_CONNECTOR_ID, BEDROCK_TITLE } from '../../../common/genai/constants';
import { GenAiActionParams, GenAiConnector } from './types';

interface ValidationErrors {
  subAction: string[];
  body: string[];
}
export function getConnectorType(): GenAiConnector {
  return {
    ...
    validateParams: async (
      actionParams: GenAiActionParams
    ...
    actionConnectorFields: lazy(() => import('./genai_connector')),
    actionParamsFields: lazy(() => import('./params')),
    actionReadOnlyExtraComponent: lazy(() => import('./genai_dashboard_link')),
  };
}
